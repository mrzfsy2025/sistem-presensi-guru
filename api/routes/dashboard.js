...
console.log("Hasil Query Presensi:", presensiSummary); // <-- TAMBAHKAN INI
        ...
        const [izinSummary] = await db.query(
            ...
            WHERE status = 'Disetujui' AND tanggal_mulai <= $1 AND tanggal_selesai >= S2;`,
